...
exports.createServer = function({
    ...
    */
	...
	const oauth = new Buffer(JSON.stringify(req.query)).toString('base64');
    ...
    */
	...
	request({
	    ...
	    const qs = JSON.parse(new Buffer(req.params.oauth, 'base64').toString('ascii'));
    ...
    */
	...
	if (m)
		...
		new Buffer(m[1], 'base64').toString('utf8').split(':');
